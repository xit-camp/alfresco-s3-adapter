...
# Signing version for s3 sdk. s3v4 is the default signing method. When working with custom s3 providers, this might have to be changed. Allowed values are s3v4, s3.
aws.s3.signatureVersion=s3v4
